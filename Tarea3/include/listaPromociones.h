...
//* PRE: no existe promoción con el mismo id en la lista
...
// secuencial la función imprimirTPromocion. Si la lista es vacía no imprime nada. 
...
// de las promociones en la colección. 
// La función es O(n) peor caso, siendo n la cantidad de promociones en la lista.
...
// promoción con ese id. 
// La función es O(n) peor caso, siendo n la cantidad de promociones en la lista* PRE: La promoción pertenece a la lista.
...
// finalizadas de la lista parámetro. 
...
// promoción es compatible con todas las promociones de la lista. 
// La función es O(n) peor caso, donde n es la cantidad de promociones de la lista.
...
//  con todos los elementos de ambas listas. 
//  La función es O(n1 + n2) peor caso, donde n es la cantidad de cantidad de promociones en la primera lista y n2
